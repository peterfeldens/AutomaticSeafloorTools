...
#define __PYX_HAVE__fast_coord
#define __PYX_HAVE_API__fast_coord
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'fast_coord' */
...
static PyObject *__pyx_f_10fast_coord_pixel_coord_fast(double, double, double, double, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "fast_coord"
extern int __pyx_module_is_main_fast_coord;
int __pyx_module_is_main_fast_coord = 0;

/* Implementation of 'fast_coord' */
...
static const char __pyx_k_ulx[] = "ulx";
static const char __pyx_k_uly[] = "uly";
...
static const char __pyx_k_pixel_coordinates_x[] = "pixel_coordinates_x";
static const char __pyx_k_pixel_coordinates_y[] = "pixel_coordinates_y";
...
static PyObject *__pyx_n_s_pixel_coordinates_x;
static PyObject *__pyx_n_s_pixel_coordinates_y;
...
static PyObject *__pyx_n_s_ulx;
static PyObject *__pyx_n_s_uly;
...
static PyObject *__pyx_pf_10fast_coord_pixel_coord_fast(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_xres, double __pyx_v_yres, double __pyx_v_ulx, double __pyx_v_uly, __Pyx_memviewslice __pyx_v_pixel_coordinates_x, __Pyx_memviewslice __pyx_v_pixel_coordinates_y); /* proto */
...
static PyObject *__pyx_pw_10fast_coord_1pixel_coord_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_10fast_coord_pixel_coord_fast(double __pyx_v_xres, double __pyx_v_yres, double __pyx_v_ulx, double __pyx_v_uly, __Pyx_memviewslice __pyx_v_pixel_coordinates_x, __Pyx_memviewslice __pyx_v_pixel_coordinates_y, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_xp;
  double __pyx_v_yp;
  int __pyx_v_x;
  int __pyx_v_y;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("pixel_coord_fast", 0);
 ...
 * 
 */
  __pyx_v_h = (__pyx_v_pixel_coordinates_x.shape[0]);
 ...
 * 
 */
  __pyx_v_w = (__pyx_v_pixel_coordinates_x.shape[1]);
 ...
 */
      __pyx_v_xp = (__pyx_v_ulx + (__pyx_v_x * __pyx_v_xres));
 ...
 */
      __pyx_v_yp = (__pyx_v_uly + (__pyx_v_y * __pyx_v_yres));
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_pixel_coordinates_x.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_pixel_coordinates_x.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_pixel_coordinates_x.shape[1];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_pixel_coordinates_x.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 18, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pixel_coordinates_x.data + __pyx_t_7 * __pyx_v_pixel_coordinates_x.strides[0]) ) + __pyx_t_8 * __pyx_v_pixel_coordinates_x.strides[1]) )) = __pyx_v_xp;
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_pixel_coordinates_y.shape[0];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_pixel_coordinates_y.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_pixel_coordinates_y.shape[1];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_pixel_coordinates_y.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 19, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pixel_coordinates_y.data + __pyx_t_8 * __pyx_v_pixel_coordinates_y.strides[0]) ) + __pyx_t_7 * __pyx_v_pixel_coordinates_y.strides[1]) )) = __pyx_v_yp;
    }
  }
 ...
 *      return test
 */
  __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_pixel_coordinates_y, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = __pyx_memoryview_fromslice(__pyx_v_pixel_coordinates_x, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_12 = PyList_New(2); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 24, __pyx_L1_error)
  ...
  __pyx_t_10 = 0;
  __pyx_t_11 = 0;
  __pyx_v_test = ((PyObject*)__pyx_t_12);
  __pyx_t_12 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("fast_coord.pixel_coord_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_10fast_coord_1pixel_coord_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10fast_coord_1pixel_coord_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_xres;
  double __pyx_v_yres;
  double __pyx_v_ulx;
  double __pyx_v_uly;
  __Pyx_memviewslice __pyx_v_pixel_coordinates_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_pixel_coordinates_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pixel_coord_fast (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_xres,&__pyx_n_s_yres,&__pyx_n_s_ulx,&__pyx_n_s_uly,&__pyx_n_s_pixel_coordinates_x,&__pyx_n_s_pixel_coordinates_y,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_xres)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_yres)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, 1); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ulx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, 2); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_uly)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, 3); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pixel_coordinates_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, 4); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pixel_coordinates_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, 5); __PYX_ERR(0, 3, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "pixel_coord_fast") < 0)) __PYX_ERR(0, 3, __pyx_L3_error)
      }
    ...
    __pyx_v_xres = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_xres == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_yres = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_yres == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_ulx = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_ulx == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_uly = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_uly == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_pixel_coordinates_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pixel_coordinates_x.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_pixel_coordinates_y = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pixel_coordinates_y.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pixel_coord_fast", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fast_coord.pixel_coord_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10fast_coord_pixel_coord_fast(__pyx_self, __pyx_v_xres, __pyx_v_yres, __pyx_v_ulx, __pyx_v_uly, __pyx_v_pixel_coordinates_x, __pyx_v_pixel_coordinates_y);
...
static PyObject *__pyx_pf_10fast_coord_pixel_coord_fast(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_xres, double __pyx_v_yres, double __pyx_v_ulx, double __pyx_v_uly, __Pyx_memviewslice __pyx_v_pixel_coordinates_x, __Pyx_memviewslice __pyx_v_pixel_coordinates_y) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("pixel_coord_fast", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_pixel_coordinates_x.memview)) { __Pyx_RaiseUnboundLocalError("pixel_coordinates_x"); __PYX_ERR(0, 3, __pyx_L1_error) }
  if (unlikely(!__pyx_v_pixel_coordinates_y.memview)) { __Pyx_RaiseUnboundLocalError("pixel_coordinates_y"); __PYX_ERR(0, 3, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_10fast_coord_pixel_coord_fast(__pyx_v_xres, __pyx_v_yres, __pyx_v_ulx, __pyx_v_uly, __pyx_v_pixel_coordinates_x, __pyx_v_pixel_coordinates_y, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_pixel_coordinates_x, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_pixel_coordinates_y, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_coord._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"pixel_coord_fast", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10fast_coord_1pixel_coord_fast, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_fast_coord(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_coord},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pixel_coordinates_x, __pyx_k_pixel_coordinates_x, sizeof(__pyx_k_pixel_coordinates_x), 0, 0, 1, 1},
  {&__pyx_n_s_pixel_coordinates_y, __pyx_k_pixel_coordinates_y, sizeof(__pyx_k_pixel_coordinates_y), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_ulx, __pyx_k_ulx, sizeof(__pyx_k_ulx), 0, 0, 1, 1},
  {&__pyx_n_s_uly, __pyx_k_uly, sizeof(__pyx_k_uly), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfast_coord(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfast_coord(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fast_coord(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_coord(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_coord(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_coord' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fast_coord(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fast_coord", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fast_coord) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_coord")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_coord", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_coord", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_coord");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
